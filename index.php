...
register.</p>
 ...
 <?php
// DB connection info
// TODO: Update the values for $host, $user, $pwd, and $db //using the values you retrieved $host = "mkostic-server.mysql.database.azure.com";
$host = "mkostic-server.mysql.database.azure.com";
$user = "ixjakujnzm";
$pwd = "FH6IPAX860PN6624$";
$db = "ruaplv3";
// Connect to database.
